...
|return|RETURN отображается в окне трассировки, когда утверждение истино и предикат совершил возврат. Если существуют другие утверждения, которые удовлетворяют входным параметрам, то будет отображаться звёздочка, как индикатор того, что утверждение находится в точке отката.|
